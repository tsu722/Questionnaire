	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="thumbnail">
						<img alt="300x200" src="/ActivityPic/${requestScope.sampleVideo.mSkchImgUrl }" />
						<div class="caption">
							<h3>
								${requestScope.sampleVideo.mVidName }
							</h3>
							<p>
								生成时间：${requestScope.sampleVideo.mVidGrnTime } 
								Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.
							</p>
							<p>
								 <a class="btn btn-primary" href="view/${requestScope.sampleVideo.mVidUrl }">播放</a> <a class="btn" href="#">Action</a>
							</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="thumbnail">
						<img alt="300x200" src="../image/loginBg.jpg" />
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
